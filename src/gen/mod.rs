...
pub(super) use nm_connection_active::OrgFreedesktopNetworkManagerSyncConnectionActive;
...
pub(super) use nm_settings_connection::OrgFreedesktopNetworkManagerSettingsSyncConnection;
pub(super) use nm_vpn_connection::OrgFreedesktopNetworkManagerVPNSyncConnection;
