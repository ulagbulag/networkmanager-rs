...
pub(super) use nm_connection_active::OrgFreedesktopNetworkManagerSyncSyncConnectionActive;
...
pub(super) use nm_settings_connection::OrgFreedesktopNetworkManagerSettingsSyncSyncConnection;
pub(super) use nm_vpn_connection::OrgFreedesktopNetworkManagerVPNSyncSyncConnection;
